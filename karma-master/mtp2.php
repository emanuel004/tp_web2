			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mtp2.jpg" alt="mtp2">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mtp2.jpg" alt="mtp2">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Zapatillas Provoke XT Untamed</h3>
						<h2>$149.99</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Categoría</span> : Training</a></li>
							<li><a href="#"><span>Disponibilidad</span> : En Stock</a></li>
						</ul>
						<p>Desata tu lado salvaje con este llamativo diseño de la exclusiva colección Provoke XT Untamed. El estampado de piel de víbora se combina en ellas con el brillo de los detalles</p>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										<h5>Suela exterior de goma con puntos de tracción</h5>
									</td>
								</tr>
								<tr>
									<td>
