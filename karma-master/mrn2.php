			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mrn2.jpg" alt="mrn2">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mrn2.jpg" alt="mrn2">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Zapatillas Joyride</h3>
						<h2>$149.99</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Categoría</span> : Running</a></li>
							<li><a href="#"><span>Disponibilidad</span> : En Stock</a></li>
						</ul>
						<p>Microesferas desde el talón hasta los dedos para una amortiguación que le da a tus piernas un día de descanso. Una capellada confeccionada con mesh elástico te provee un ajuste increíblemente cómodo, seguro y personalizado.</p>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										<h5>entresuela con capacidad de respuesta.</h5>
									</td>
								</tr>
								<tr>
									<td>
