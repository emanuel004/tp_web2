	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Zapatillas Adidas Galaxy 5</h1>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mra2.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mra2.jpg" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Zapatillas Galaxy 5</h3>
						<h2>$149.99</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Categoría</span> : Running</a></li>
							<li><a href="#"><span>Disponibilidad</span> : En Stock</a></li>
						</ul>
						<p>Hacé que cada kilómetro cuente. Estas zapatillas de running adidas llenan cada paso con comodidad, sin importar la distancia. Tus pies prácticamente se hunden en la amortiguación suave. Te harán pensar que podés correr para siempre, o por lo menos por unos kilómetros más. Vos tenés el control.</p>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										<h5>Mediasuela con amortiguación Cloudfoam y suela de caucho</h5>
									</td>
								</tr>
								<tr>
									<td>
