	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Zapatillas Nike Flex Control 4</h1>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/htn1.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/htn1.jpg" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						perfectas para tus jornadas de entrenamiento al aire libre o en el gimnasio, sentite fresco y cómodo gracias a la malla transpirable de su capellada, recubrimiento sintético otorga mayor durabilidad; además su tecnología Flywire une finos filamentos con los cordones dándote mayor sujeción al pie, 
						su suela de goma te da mejor tracción dándote mayor estabilidad en cualquier superficie.</p>
