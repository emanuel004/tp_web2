	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Zapatillas Nike Zoom Pegasus Turbo 2</h1>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/hrn1.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/hrn1.jpg" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>zapatillas Zoom Pegasus Turbo 2</h3>
						<h2>$149.99</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Categoría</span> : Running</a></li>
							<li><a href="#"><span>Disponibilidad</span> : En Stock</a></li>
						</ul>
						<p>Las zapatillas deportivas de hombre Nike Legend React le proporcionan confort aerodinámico y estilo casual. 
						La entre suela de goma de reacción muy suave amortigua cada paso, 
						mientras que la parte superior ligera y diseño de bota parcial le brindan soporte estratégico 
						y facilita la colocación y remoción.</p>
