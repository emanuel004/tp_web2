			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mra1.jpg" alt="mra1">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mra1.jpg" alt="mra1">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>Prototipo tras prototipo. Innovación tras innovación. Prueba tras prueba. Uníte a nosotros en la busqueda constante de maximizar y armonizar el peso, la comodidad y en rendimiento. Ultraboost 21. Descubrí un retorno de energía increíble.</p>
