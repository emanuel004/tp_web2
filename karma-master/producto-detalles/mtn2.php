	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Zapatillas Nike Zoom Gravity</h1>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mtn2.jpg" alt="mtn2">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/mtn2.jpg" alt="mtn2">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Zapatillas Zoom Gravity</h3>
						<h2>$149.99</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Categoría</span> : Training</a></li>
							<li><a href="#"><span>Disponibilidad</span> : En Stock</a></li>
						</ul>
						<p>Diseñadas para el entrenamiento de velocidad, las Nike Zoom Gravity están confeccionadas para que pueda avanzar desde carreras continuas rápidas a carreras ganadoras.</p>
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										<h5>Capellada: Tela de red | Suela: Goma</h5>
									</td>
								</tr>
								<tr>
									<td>
