	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Zapatillas Adidas Fitbounce</h1>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/hta2.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/hta2.jpg" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						Presentan un diseño con exterior de malla que mantiene los pies frescos, amortiguación en la mediasuela que brinda comodidad y 
						agilidad insuperables y una suela con tracción multidirecional para todo tipo de superficies.</p>
