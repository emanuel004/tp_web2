	...
	<section class="banner-area organic-breadcrumb">
		<div class="container">
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					<h1>Zapatillas Nike Air Max Alpha Trainer 2</h1>
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/htn2.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product-details/htn2.jpg" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						durabilidad, tracción y amortiguación que te permitirán realizar el entrenamiento diario sin ningún problema.
						Estabilidad, absorción de impactos y comodidad.
						El cuello suave y el cojín Max Air en el área del talón brindan estabilidad y amortiguación, además de aumentar la comodidad durante todo el entrenamiento.
						Resistencia durante el entrenamiento en el gimnasio.</p>
